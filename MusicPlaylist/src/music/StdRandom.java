...
<<<<<<< HEAD
     ...
     * same sequence of "random" number for each execution of the program. Ordinarily, you should
     * call this method at most once per program.
     *
     * @param s the seed
     */
...
>>>>>>> parent of d02b300 (Formatted Code)
    ...
    /**
<<<<<<< HEAD
     * Returns a random real number from a Gaussian distribution with mean &mu; and standard
     * deviation &sigma;.
     *
     * @param mu the mean
...
<<<<<<< HEAD
     ...
     * The integer represents the number of independent trials before the first success.
     *
...
=======
     ...
     *         probability {@code p}; or {@code Integer.MAX_VALUE} if {@code p}
     *         is (nearly) equal to {@code 1.0}.
...
=======
     ...
     *     1.0}
     * @throws IllegalArgumentException unless {@code probabilities[i] >= 0.0}
     *                                  for each index {@code
>>>>>>> parent of d02b300 (Formatted Code)
     *     i}
     */
...
=======
            throw new IllegalArgumentException(
                    "argument array must not be null");
>>>>>>> parent of d02b300 (Formatted Code)
...
=======
                throw new IllegalArgumentException("array entry " + i
                        + " must be non-negative: " + probabilities[i]);
>>>>>>> parent of d02b300 (Formatted Code)
            sum += probabilities[i];
        }
...
<<<<<<< HEAD
     * @return a random integer from a discrete distribution: {@code i} with probability
     *     proportional to {@code frequencies[i]}
     ...
     * @throws IllegalArgumentException if {@code frequencies[i]} is negative for any index {@code
     *     i}
...
=======
     ...
     * @throws IllegalArgumentException if {@code frequencies} is {@code null}
     * @throws IllegalArgumentException if all array entries are {@code 0}
     * @throws IllegalArgumentException if {@code frequencies[i]} is negative
    ...
    public static int discrete(int[] frequencies) {
        ...
        for (int i = 0; i < frequencies.length; i++) {
            if (frequencies[i] < 0)
                throw new IllegalArgumentException("array entry " + i
                        + " must be non-negative: " + frequencies[i]);
            sum += frequencies[i];
        }
        if (sum == 0)
            throw new IllegalArgumentException(
...
=======
     ...
     *         permutation of {@code 0}, {@code 1}, ..., {@code n-1}
     */
    public static int[] permutation(int n) {
        if (n < 0)
...
<<<<<<< HEAD
     * @return an array of length {@code k} that is a uniformly random permutation of {@code k} of
     *     the elements from {@code 0}, {@code 1}, ..., {@code n-1}
     */
