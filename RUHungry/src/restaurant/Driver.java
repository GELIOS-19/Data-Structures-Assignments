...
public class Driver {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      while (ptr != null) {
        StdOut.print(
            ...
            "  ID: " + ptr.getIngredient().getID() + " Price: " +
  ...
  public static void testDelete(RUHungry restaurant,
    ...
    for (int i = 0; i < 10; i++) {
      ...
      StockNode ptr = stockVar[i];
      while (ptr != null) {
        StdOut.print(ptr.getIngredient().getName() +
                     "  ID: " + ptr.getIngredient().getID() +
                     " Price: " + ptr.getIngredient().getCost() +
                     " Stock Level: " + ptr.getIngredient().getStockLevel());
        StdOut.println();
  ...
  public static void testIndividualMethods(String inputOrdersFile,
    ...
    while (ptr != null) {
      ...
      StdOut.println("Type: " + type + ", Name: " + item +
  ...
  public static void testTransactionMethods(String inputOrdersFile,
    ...
    for (int orderNumber = 0; orderNumber < numOrders; orderNumber++) {
      String type =
          StdIn.readString(); // can be either "order" "donation" "restock"
      StdIn.readChar();       // empty
      int amountOrdered =
          StdIn.readInt(); // reads how much was ordered/restocked
      StdIn.readChar();
      String itemOrdered =
