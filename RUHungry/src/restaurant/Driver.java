...
public class Driver {
  ...
  public static void main(String[] args) {
    ...
    String[] methodsToTest = {
      "Menu", "StockRoom", "Delete StockNode", "Transactions", "SeatAllGuests", "Quit",
    };
    ...
    do {
      ...
      switch (choice) {
        ...
        case 4:
          ...
          StdIn.resetFile();
          StdOut.print(
              "Quick Question! Do you want to test an individual transaction method (order,"
                  + " donation, restock)? [ Y OR N ] => ");
