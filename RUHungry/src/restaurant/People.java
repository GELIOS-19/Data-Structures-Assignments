...
public class People {
  ...
  public void setNumberInParty(int numberInPartyInput) {
    numberInParty = numberInPartyInput;
  }

  public void setNameOfParty(String nameOfPartyInput) {
    nameOfParty = nameOfPartyInput;
  }

  public int getTableIndex() { return tableIndex; }

  public void setTableIndex(int tableIndexInput) {
    tableIndex = tableIndexInput;
  }
}