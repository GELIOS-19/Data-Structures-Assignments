...
/******************************************************************************
 * Compilation: javac Queue.java Execution: java Queue < input.txt Dependencies:
 * StdIn.java StdOut.java Data files:
 * https://algs4.cs.princeton.edu/13stacks/tobe.txt A generic queue, implemented
 * using a linked list. % java Queue < tobe.txt to be or not to be (2 left on
 * queue)
 ******************************************************************************/
