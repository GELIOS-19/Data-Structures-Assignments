...
public class WeightedQuickUnionUF {
   ...
   * the the smaller branch as the child of the larger branch, then set the
   * size of the larger branch as the sum of both branches.
   *
   * <p>
   * Union is limited to the time complexity of the Find operation, as all the
   * other operations take constant time. Due to the improvement of making
   * this operation Weighted, the Find operation is sped up to a time
   ...
   */
  public int getSize(GridLocation cell) { return size[cell.row][cell.col]; }
}
