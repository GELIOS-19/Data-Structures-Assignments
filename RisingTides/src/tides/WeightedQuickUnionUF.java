...
/**
 * DO NOT EDIT! This class is an implmentation of Weighted Quick Union.
 *
 * <p>Feel free to take a look at the method descriptions for a better understanding of Weighted
 * Quick-Union.
 *
...
public class WeightedQuickUnionUF {
     ...
     *
     * <p>Instantiates the total number of rows and columns provided (size of the .terrain file) and
     * the parent and size 2d arrays.
     *
    ...
    /**
     * Since this is a Quick-Union implementation, this method iteratively goes up the parent nodes
     * until arriving at the root node (curr == currParent).
     *
     * <p>Thanks to using Weighted Union rather than the normal Union, the Find operation time
     * complexity is O(logn) compared to O(n).
     *
     ...
     *
     * <p>Find the root parents of the cell parameters, find the larger branch, set the the smaller
     * branch as the child of the larger branch, then set the size of the larger branch as the sum
     * of both branches.
     *
     * <p>Union is limited to the time complexity of the Find operation, as all the other operations
     * take constant time. Due to the improvement of making this operation Weighted, the Find
     * operation is sped up to a time complexity of O(logn), thus making this implementation of
     * Union also O(logn), compared to the O(n) time complexity for the normal Union.
     *
