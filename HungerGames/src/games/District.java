 ...
 *
 * <p>Contains two ArrayLists of Odd Population and Even Population based on
 * birth date.
 *
...
public class District {
   ...
   */
  public void addOddPerson(Person person) { oddPopulation.add(person); }
   ...
   */
  public void addEvenPerson(Person person) { evenPopulation.add(person); }
   ...
   */
  public ArrayList<Person> getOddPopulation() { return oddPopulation; }
   ...
   */
  public ArrayList<Person> getEvenPopulation() { return evenPopulation; }
   ...
   */
  public void setOddPopulation(ArrayList<Person> op) { oddPopulation = op; }
   ...
   */
  public void setEvenPopulation(ArrayList<Person> ep) { evenPopulation = ep; }
   ...
   */
  public int size() { return oddPopulation.size() + evenPopulation.size(); }
