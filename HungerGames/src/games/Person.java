...
public class Person implements Comparable<Person> {
    ...
    private boolean tessera; // if true this person has volunteered to participate in the games
    ...
    /**
     * A scalar between 0 and 2.0 is applied on both Persons' EFFECTIVENESS, highest resulting
     * rating will win the encounter.
     *
