...
public class Person implements Comparable<Person> {
  ...
  private boolean tessera; // if true this person has volunteered to
                           // participate
  // in the games
  ...
  public Person(int birthMonth, String firstName, String lastName, int age,
                int districtID, int effectiveness)
  ...
  /**
   * Gets the effectiveness of this person in combat when calling
   * fight(person).
   *
  ...
  /**
   * Allows the ability to set this Person's Tessera
   *
   * @param tessera will define this object's Tessera as true or false
   */
  public void setTessera(boolean tessera) { this.tessera = tessera; }
   ...
   */
  public boolean getTessera() { return tessera; }
   ...
   * @return person such that person has the greater Effectiveness after luck
   *         is applied than the other person i.e Winner of Fight
   */
   ...
   * districtID's and full names Useful for using Collections.sort on a list
   * of this type.
   *
   * @param person2
