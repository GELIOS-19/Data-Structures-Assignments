...
public final class StdRandom {
   ...
   * @return a random long integer uniformly between 0 (inclusive) and {@code
   *   n} (exclusive)
   * @throws IllegalArgumentException if {@code n <= 0}
   */
   ...
   */
  public static double pareto() { return pareto(1.0); }
   ...
   *                                      for any index {@code
   *     i}
   * @throws IllegalArgumentException if sum of frequencies exceeds {@code
  ...
  private static void validateSubarrayIndices(int lo, int hi, int length) {
    if (lo < 0 || hi > length || lo > hi) {
      throw new IllegalArgumentException("subarray indices out of bounds: [" +
                                         lo + ", " + hi + ")");
    }
  }
