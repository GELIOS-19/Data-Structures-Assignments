 ...
 * <p>
 * Step 2: ValidPreReqInputFile name is passed through the command line as
 * args[1] Read from ValidPreReqInputFile with the format: 1. 1 line containing
 * the proposed advanced course 2. 1 line containing the proposed prereq to the
 * advanced course
 * <p>
 * Step 3: ValidPreReqOutputFile name is passed through the command line as
 * args[2] Output to ValidPreReqOutputFile with the format: 1. 1 line,
...
public class ValidPrereq {
  ...
  private static boolean hasCycle(Map<String, List<String>> adjList,
    ...
    // be reached
    for (String neighbor : adjList.getOrDefault(current,
  ...
  private static boolean createsCycle(Map<String, List<String>> adjList,
      String newPrereq, String start) {
