 ...
 * <p>
 * Step 2: EligibleInputFile name is passed through the command line as args[1]
 * Read from EligibleInputFile with the format: 1. c (int): Number of courses 2.
 * c lines, each with 1 course ID
 * <p>
 * Step 3: EligibleOutputFile name is passed through the command line as args[2]
 * Output to EligibleOutputFile with the format: 1. Some number of lines, each
 * with one course ID
 */
public class Eligible {
  ...
  private static Set<String> getEligibleCourses(
