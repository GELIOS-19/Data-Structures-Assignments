 ...
 *
 * <p>Step 2: EligibleInputFile name is passed through the command line as args[1] Read from
 * EligibleInputFile with the format: 1. c (int): Number of courses 2. c lines, each with 1 course
 * ID
 *
 * <p>Step 3: EligibleOutputFile name is passed through the command line as args[2] Output to
 * EligibleOutputFile with the format: 1. Some number of lines, each with one course ID
 */
public class Eligible {
  public static void main(String[] args) {
    if (args.length < 3) {
      StdOut.println(
          "Execute: java -cp bin prereqchecker.Eligible <adjacency list INput file> <eligible INput"
              + " file> <eligible OUTput file>");
      return;
    }
