 ...
 * <p>
 * Step 2: AdjListOutputFile name is passed through the command line as args[1]
 * Output to AdjListOutputFile with the format: 1. c lines, each starting with a
 * different course ID, then listing all of that course's prerequisites (space
 * separated)
 */
public class AdjList {
  ...
  public static void main(String[] args) {
    ...
    for (String courseID : courseIDs) {
      ...
      List<String> prereqs = adjList.getOrDefault(courseID,
  ...
  public static Map<String, List<String>> getAdjList(String adjListInputFile) {
    ...
    Map<String, List<String>> adjList = new HashMap<String, List<String>>(); // Create
                                                                             // an
                                                                             // adjacency
                                                                             // list
                                                                             // while
  ...
  public static Set<String> getAllPrereqs(Map<String, List<String>> adjList,
      Set<String> courses) {
