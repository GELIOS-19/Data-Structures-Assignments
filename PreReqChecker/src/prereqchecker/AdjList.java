...
public class AdjList {
  ...
  public static void main(String[] args) {
    if (args.length < 2) {
      StdOut.println(
          "Execute: java -cp bin prereqchecker.AdjList <adjacency list INput file> <adjacency list"
              + " OUTput file>");
      return;
    }
  ...
  public static Map<String, List<String>> getAdjList(String adjListInputFile) {
    ...
    Map<String, List<String>> adjList =
        new HashMap<String, List<String>>(); // Create an adjacency list while parsing the input
  ...
  public static Set<String> getAllPrereqs(Map<String, List<String>> adjList, Set<String> courses) {
